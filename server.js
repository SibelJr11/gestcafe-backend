...
const pagos_suscripcionRoutes = require("./routes/pagos_suscripcion");
...
const io = new Server(server, {
      cors: {
            origin: "https://gestcafe.netlify.app",
            methods: ["GET", "POST"],
      },
});
...
io.on("connection", (socket) => {
      ...
      socket.on("disconnect", () => {
            ...
            console.log(
                  "Usuarios conectados después de la desconexión:",
                  Array.from(connectedUsers.values())
            );
...
app.use("/api/pagos-suscripcion", pagos_suscripcionRoutes);
